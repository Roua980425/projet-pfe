...
def preprocess(data_path, number):  # data_path
    ...
    for filename in os.listdir(data_path + "/tumor"):
        i = i + 1
        df.loc[i] = ["tumor", data_path + "/tumor/" + filename]

    for filename in os.listdir(data_path + "/no_tumor"):
        i = i + 1
        df.loc[i] = ["no_tumor", data_path + "/no_tumor/" + filename]
