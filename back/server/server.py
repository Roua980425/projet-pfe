...
'''
test_path="C:\\Users\\user\\PFE\\pfe1\\pfe1\\FL_Dataset2\\2"
def launch_fl_session(num_rounds: int, ipaddress: str, port: int, resume: bool):
    ...
    with open('C:\\Users\\user\\PFE\\pfe1\\pfe1\\back\\config_training.json', 'r+') as file:
    ...
    with open('C:\\Users\\user\\PFE\\pfe1\\pfe1\\back\\strategy_coefs.json ', 'r') as file:
        config = json.load(file)
...
launch_fl_session(2, '127.0.0.1', 8080, True)